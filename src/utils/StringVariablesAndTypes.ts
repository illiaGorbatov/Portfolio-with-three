...
export const STATIC_LANDSCAPE = 'static landscape';
export const TRANSITION_TO_EXPLOSION = 'transition to explosion';
export const RADIAL_EXPLOSION = 'redial explosion';
...
export const SET_SCENE = 'REDUX/SET_SCENE';
...
export const SET_EXPLOSION_PROGRESS = 'REDUX/SET_EXPLOSION_PROGRESS';
export const SET_MAIN_PAGE_STATE = 'REDUX/SET_MAIN_PAGE_STATE';
export const SET_PROJECTS_AVAILABILITY = 'REDUX/SET_PROJECTS_AVAILABILITY';
